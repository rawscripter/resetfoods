                ...
                <div class="breadcrumb-main application-ui mb-30">
					<div class="breadcrumb-action d-flex">
						<div class="d-flex align-items-center user-member__title mr-sm-25 mr-0">
							<h4 class="text-capitalize fw-500 breadcrumb-title">Shopping Dashboard</h4>
						</div> 
						<div class="action-btn mr-10 my-sm-0">
							<a href="orders" class="btn radius-md btn-primary bg-primary fs-12 fw-500">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye"><path data-v-2119d3c9="" d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle data-v-2119d3c9="" cx="12" cy="12" r="3"></circle></svg>
                            View Orders</a>
						</div> 
						<div class="btn-group-toggle"><div class="btn btn-light ">
							<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check" data-v-c1c03ece=""><polyline points="20 6 9 17 4 12"></polyline></svg>
                            Analytics
                        </div></div></div>
                    ...
                    <div class="breadcrumb-action justify-content-center flex-wrap">
                        ...
                        <div class="action-btn">
                            <a href="" class="btn btn-sm btn-primary btn-add">
                                <i class="la la-plus"></i> Create Offer</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0">
                    <div class="card-header">
                        ...
                        <div class="card-extra">
                            ...
                            <div class="dropdown dropleft">
                                <a href="#" role="button" id="somethings" data-toggle="dropdown" aria-haspopup="true"
                                   aria-expanded="false">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                         fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                         stroke-linejoin="round" class="feather feather-more-horizontal">
