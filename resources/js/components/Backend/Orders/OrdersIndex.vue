...
<div>
                    ...
                    <div class="col-lg-12">
                        <div class="shop-breadcrumb">
                            ...
                            <div class="breadcrumb-main">
                                <h4 class="text-capitalize breadcrumb-title">Shopping Orders</h4>
                                <div class="breadcrumb-action justify-content-center flex-wrap">
                                    ...
                                    <div class="dropdown action-btn">
                                        <button class="btn btn-sm btn-default btn-white dropdown-toggle" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="la la-download"></i> Export orders
                                        </button>
                                    ...
                                    <div class="dropdown action-btn">
                                        <button class="btn btn-sm btn-default btn-white dropdown-toggle" type="button" id="dropdownMenu3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="la la-share"></i> View all orders
                                        </button>
                                    ...
                                    <div class="action-btn">
                                        <a href="#" class="btn btn-sm btn-primary btn-add">
                                            <i class="la la-plus"></i> Create Order</a>
                                    </div>
                                </div>
                            </div>
	...
	<div class="container-fluid">
        <div class="row content-center">
			<div class="col-xl-3 col-xxl-6 col-ssm-12 mb-10">
			</div>
			<div class="col-xl-3 col-xxl-6 col-ssm-12 mb-10">
			</div>
			<div class="col-xl-3 col-xxl-6 col-ssm-12 mb-10">
			</div>
			<div class="col-xl-3 col-xxl-6 col-ssm-12 mb-10  row content-center">
				<div class="col-xl-9 col-xxl-9 col-ssm-12">
				<h4 class="breadcrumb-title">www.shopname.com</h4>
				<small>Connection</small>
				<span class="color-success"><strong>  Active</strong></span>
				<small> | Woocommerce</small>
				</div>
				<div class="col-xl-2 col-xxl-2 col-ssm-12 mt-20">
                            ...
                            <div class="project-top-wrapper d-flex justify-content-between flex-wrap mb-25 mt-n10">
                                <div class="d-flex align-items-center flex-wrap justify-content-center">
                                    <div class="project-search order-search  global-shadow mt-10">
                                        <form action="/" class="order-search__form">
                                            ...
                                            <input class="form-control mr-sm-2 border-0 box-shadow-none" type="search" placeholder="Search order" aria-label="Search order">
											<input type="hidden" value="" id="offer_id">
										</form>
                                ...
                                <div class="content-center mt-10">
                                    <div class="button-group m-0 mt-xl-0 mt-sm-10 order-button-group">
                                        <button type="button" class="order-bg-opacity-secondary text-secondary btn radius-md">Last time: 12-03-2021</button>
                                        <button type="button" class="btn btn-sm btn-primary mr-0 radius-md">
                                            <i class="la la-plus"></i> Sync order</button>
                                    </div>
                                        ...
                                        <table class="table mb-0 table-hover table-borderless border-0">
                                            <thead>
                                                <tr class="userDatatable-header">
                                                    ...
                                                    <th>
                                                        <span class="userDatatable-title float-right">Order Date</span>
                                                    </th>
                                                    <th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr  v-for="order in lists.data">
                                                    ...
                                                    <td>
                                                        <div class="orderDatatable-status d-inline-block" v-if="order.order_status == 'pending'">
                                                            <span class="order-bg-opacity-info  text-info rounded-pill active">{{order.order_status}}</span>
                                                        </div>
														<div class="orderDatatable-status d-inline-block" v-if="order.order_status == 'completed'">
                                                            <span class="order-bg-opacity-success  text-success rounded-pill active">{{order.order_status}}</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="orderDatatable-status d-inline-block" v-if="order.paid_status == 'Paid'">
                                                           <span class="order-bg-opacity-success  text-success rounded-pill active">{{order.paid_status}}</span>
                                                        </div>
														
														<div class="orderDatatable-status d-inline-block" v-if="order.paid_status == 'Unpaid'">
                                                           <span class="order-bg-opacity-info  text-info rounded-pill active">{{order.paid_status}}</span>
                                                        </div>
                                                    </td>
													<td>
                                                        <div class="orderDatatable-title">
                                ...
                                <nav class="atbd-page ">
                                    <ul class="atbd-pagination d-flex">
                                        <li class="atbd-pagination__item">
                                            ...
                                            <a href="#" class="atbd-pagination__linkactive"><span class="page-number">1</span></a>
...
export default {
    ...
    methods: {
		...
		getOrders() {
            axios.post(`table/data/all/orders?offer=`)
                .then(resp => {
                    this.lists = resp.data;
                    this.orderListAvailable = this.lists.data.length > 0;
